...
# Часть 7: Примеры (Context Pack examples)

> Используй эти примеры как шаблоны работы: гипотезы → кандидаты → Context Pack → результат.
...
**Гипотезы:**
- Интерес: правильно разместить знание
- Роль: Operations
- Система: целевая система (X2)
- Рабочий продукт: новый документ + путь

**РЕЗУЛЬТАТ:** `A2.../A2.3.Operations/metrics.md`.
...
**Гипотезы:**
- Интерес: создать структуру
- Роль: Meaning/Operations (зависит от цели)
- Система: часто эпистема → ядро не создаём
- Рабочий продукт: решение "не ядро" + правильное размещение

**РЕЗУЛЬТАТ:** документ в соответствующем семействе или ядро команды, если это действительно система.
...
**Гипотезы:**
- Интерес: развить репозиторий
- Роль: Architecture/Operations
- Система: "наша система" (подсистема/звено цепочки)
- Рабочий продукт: структура папок + обновление мостов

**РЕЗУЛЬТАТ:** создать ядро и обновить `Kernels-Bridge` и `our-systems-map`.

> **Подробнее:** [09-examples-library.md](0.1.Knowledge-Logic/09-examples-library.md#раздел-6-примеры-context-pack)
